  ...
  <div className="flex flex-col gap-2">
    ...
    {fullView ? (
          ...
          >
            <CardHeader className="p-0 relative h-[80px] bg-mono_100">
              <Image
                ...
                src={eq.image || '/default-image.png'}
              />
            </CardHeader>
      ...
      <div className="relative w-full px-6">
        ...
        <button className="swiper-button-prev-custom absolute left-[-8px] top-1/2 -translate-y-1/2 z-10 text-mono_500 hover:text-mono_900 transition">
          <ChevronLeftIcon className="w-6 h-6" />
        </button>

        <button className="swiper-button-next-custom absolute right-[-8px] top-1/2 -translate-y-1/2 z-10 text-mono_500 hover:text-mono_900 transition">
